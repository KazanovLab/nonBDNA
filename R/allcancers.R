...
ROOTDIR <- "/Users/mar/BIO/PROJECTS/APOBEC/NONBDNA/all_cancers/"
...
for(NBtype in c('apr','dr','gq','ir','mr','str','z')){
  ...
  data[, logDensity := log10((sumIN/sizeIN)/(sumOUTall/sizeOUTall))]
  ...
  ggsave(paste0("/Users/mar/BIO/PROJECTS/APOBEC/NONBDNA/pics/fig1/panel_",NBtype,".tiff"),units="mm",dpi=300,width=500,height=50)
}

write.table(results,"/Users/mar/BIO/PROJECTS/APOBEC/NONBDNA/pics/fig1/fig1_stat.txt",row.names = F, quote = F, sep='\t')
